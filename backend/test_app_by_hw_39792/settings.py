"""
Django settings for test_app_by_hw_39792 project.
...
ROOT_URLCONF = 'test_app_by_hw_39792.urls'
...
WSGI_APPLICATION = 'test_app_by_hw_39792.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_by_hw_39792 API",
    "DESCRIPTION": "API documentation for test_app_by_hw_39792 App",
    "VERSION": "v1",
}
